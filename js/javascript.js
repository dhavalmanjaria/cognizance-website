$(document).ready(function(){
	...
	var footerHTML = "<div class='mdl-mini-footer__left-section'>";
	footerHTML += "<ul class='mdl-mini-footer__link-list'>";
...
/* from http://detectmobilebrowsers.com/, This code checks if the user is on phone */

var isUserOnMobile = function (userAgent) {
